      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-14 lg:py-20">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-16">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="block text-n-600 text-[11px] font-mono tracking-wider">GESCHAEFTSFUEHRUNG</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="mt-4 text-n-600 text-sm leading-relaxed max-w-2xl">
        ...
        <motion.div className="mt-10 h-[1px] bg-n-200 relative">
          <motion.div
